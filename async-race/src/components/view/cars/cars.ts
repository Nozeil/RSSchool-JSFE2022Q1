...
export default class Cars {
  ...
  getSelectButton(parentEl: HTMLElement) {
    return this.textComponent.getTextComponent('button', parentEl, 'car__select', 'Select');
  }

  getRemoveButton(parentEl: HTMLElement) {
    return this.textComponent.getTextComponent('button', parentEl, 'car__reset', 'Remove');
  }

  getStartButton(parentEl: HTMLElement) {
    return this.textComponent.getTextComponent('button', parentEl, 'car__start', 'Start');
  }
  ...
  61 239 98 16 10 -216 242 -234 235z" />
    ...
    return this.carSvgImage.getSvgImage('div', parentEl, 'car__car-image', svg);
  }
  ...
  renderCar(
    ...
    const { startButton, endButton, selectButton, removeButton } = this.getCarControls(
      car,
      id,
      handlers,
      vehicleUpdateControls,
